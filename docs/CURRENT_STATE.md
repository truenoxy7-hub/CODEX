...
- Suite verda amb 112 proves: les 88 del baseline auditat i 24 proves noves de
...
|---|---|---|
| `ready` | 001, 002, 003, 004, 006, 008, 009, 010, 012, 013 | Contracte i entrades suficients per al gate qualitatiu actual |
| `partial` | 005, 007, 014 | Flux/informació de pilota no especificat o opcions encara simbòliques |
| `blocked` | 011, 015 | Cardinalitat o espai contigu absent |
